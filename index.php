...
$sql = "SELECT (SELECT COUNT(*) FROM users) AS user_count, (SELECT COUNT(*) FROM users_orders) AS order_count, (SELECT COUNT(*) FROM dishes) AS dish_count";
...
$total_dish = $row['dish_count'];

var_dump($row['users_count']);
?>
